...
using StudentTrackerAdminClient;
using System.Windows;
using System.Windows.Input;

namespace StudentTrackerAdminClient.ViewModels.TabPagesViewModels
{
    public class MarkTableTabPageViewModel : BaseViewModel
    {
        #region Fields
        ...
        #region Constructors
        public MarkTableTabPageViewModel()
        {
        ...
        public MarkTableTabPageViewModel(Action<Header> addHeaderHandler, Action<int> deleteHeaderHandler,
        ...
        private async void GetTeachers()
        {
            ...
            InvokeOnPropertyChangedEvent(nameof(Teachers));
        }
