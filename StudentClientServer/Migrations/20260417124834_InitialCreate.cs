    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Name = table.Column<string>(type: "text", nullable: false),
                    StudentCardNumber = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Studies", x => new { x.GroupId, x.SubjectId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_Studies_Subjects_SubjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Headers_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Headers_Teachers_TeacherId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Teaches", x => new { x.SubjectId, x.TeacherId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Marks_Headers_HeaderId",
                        column: x => x.HeaderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Headers_SubjectId",
                table: "Headers",
                column: "SubjectId");

            migrationBuilder.CreateIndex(
                name: "IX_Headers_TeacherId",
                table: "Headers",
                column: "TeacherId");

            migrationBuilder.CreateIndex(
                name: "IX_Marks_HeaderId",
                table: "Marks",
                column: "HeaderId");
